...
func NewRouterWithOptions(pool *pgxpool.Pool, hub *realtime.Hub, bus *events.Bus, analyticsClient analytics.Client, rdb *redis.Client, opts RouterOptions) chi.Router {
	...
	daemonHub.SetCommandRunStartedHandler(h.HandleDaemonCommandRunStartedWS)
	...
	r.Route("/api/daemon", func(r chi.Router) {
		...
		r.Post("/runtimes/{runtimeId}/previews/report", h.ReportRuntimePreview)
	...
	r.Group(func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/commandrunner", func(r chi.Router) {
				...
				r.Get("/workflows", h.HandleCommandWorkflowExecutionList)
				r.Post("/workflows", h.HandleCommandWorkflowExecutionCreate)
				r.Get("/workflows/{workflowId}", h.HandleCommandWorkflowExecutionGet)
				r.Patch("/workflows/{workflowId}/status", h.HandleCommandWorkflowExecutionStatusUpdate)
